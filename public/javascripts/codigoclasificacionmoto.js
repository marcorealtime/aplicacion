var app = angular.module("sampleAppMO", ["firebase"]);

app.controller("SampleCtrlMO", function($scope, $firebaseArray) {
	...
	$scope.LoadSessionData = function(val) {
		 ...
		 $scope.LoadSessionPespecial=function(val) {
					...
					pe=val;
					var ref = firebase.database().ref().child("MOTOS"+"/"+etapa+"/"+pe+"/Tiempos/");
