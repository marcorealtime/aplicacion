var app = angular.module("sampleAppCARR", ["firebase"]);

app.controller("SampleCtrlCARR", function($scope, $firebaseArray) {
	...
	$scope.LoadSessionData = function(val) {
				...
				var ref = firebase.database().ref().child($scope.carreradirecto+"/Carrera/"+clase);
