var app = angular.module("sampleAppMOCA", ["firebase"]);

app.controller("SampleCtrlMOCA", function($scope, $firebaseArray) {
	...
	$scope.carrera.$loaded().then(function () {
  	...
  	$scope.tipodirecto=$scope.carrera[0].tipo;
				...
				var ref = firebase.database().ref().child("MOTOS"+"/General/");
