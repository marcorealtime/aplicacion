var app = angular.module("sampleAppMotoi", ["firebase"]);

app.controller("SampleCtrlcatMotoi", function($scope, $firebaseArray) {
	
	
	var ref1 = firebase.database().ref().child("carrera");
	$scope.carrera = $firebaseArray(ref1);

	var ref = firebase.database().ref().child("categoriamotos");
	...
	$scope.LoadSessionData = function(val) {
					...
					var ref = firebase.database().ref().child("MOTOS"+"/Inscritos/"+val);
