var app = angular.module("sampleAppd1", ["firebase"]);

app.controller("SampleCtrlcatd1", function($scope, $firebaseArray) {
	...
	$scope.LoadSessionData = function(val) {
			        ...
			        $scope.clasem=val;
 						...
 						var reff = firebase.database().ref().child(workflowData+"/"+etapa+"/especiales/").orderByChild("orden");
		 ...
		 $scope.LoadSessionPespecial=function(val) {
					...
					pe=val;
					var ref = firebase.database().ref().child(workflowData+"/"+etapa+"/"+pe+"/Tiempos/");
